...
best_prune_acc = 0
for j in range(args.times): # 4
    # warm up & update weight optimizer
    for epoch in range(args.epochs): # 25
        model.train()
    ...
    # update Z1 U1 Z2 U2 which are used to compute loss
...
# after 100 epoch_cnt, prune graph
adj1,adj2 = model.adj1, model.adj2
...
# after 100 epoch_cnt, prune weight
